...
int main( ) {
	...
	double a, b, c, d, e, x, x_root_approx, y, yfloor, x_vertex;
	...
	//find value of x at vertex to prevent program from trying to find the tangent line at that x value
	//otherwise it will get stuck in an infinite loop and will never find root
	x_vertex = -(b/(2*a));
